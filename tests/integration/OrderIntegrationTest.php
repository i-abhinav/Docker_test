...
/** @test */
    ...
    {       
        ...
        // $this->_checkOrderUpdateAssert($orderID=null, $validRequestBody, $desiredCode=422);   //fail
        
        echo "\n ** Scenario(3). Invalid format - Order Id **";
        $this->_checkOrderUpdateAssert($orderID='12dsd', $validRequestBody, $desiredCode=406);   //fail
